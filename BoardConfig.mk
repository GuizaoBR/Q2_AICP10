...
-include vendor/quantum/Q2/BoardConfigVendor.mk
#64 bit
TARGET_ARCH := arm64
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 28759818240
...
#TARGET_KERNEL_SOURCE := kernel/quantum/Q2
#TARGET_KERNEL_CONFIG := cyanogenmod_Q2_defconfig

#for now lets use prebuilt
TARGET_PREBUILT_KERNEL := device/quantum/Q2/prebuilt/kernel
BOARD_HAS_NO_SELECT_BUTTON := true
#recovery
#TARGET_RECOVERY_INITRC := device/quantum/Q2/recovery/init.mt6753.rc
TARGET_RECOVERY_FSTAB := device/quantum/Q2/recovery/root/fstab.mt6753
TARGET_RECOVERY_LCD_BACKLIGHT_PATH := \"/sys/devices/platform/leds-mt65xx/leds/lcd-backlight/brightness\"

#system.prop
TARGET_SYSTEM_PROP := device/quantum/Q2/system.prop
...
BOARD_EGL_CFG := device/quantum/Q2/egl.cfg
